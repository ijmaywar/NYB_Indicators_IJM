...
ds<-read.csv("forage_spring_2023.csv", header = TRUE)
...
ds2<-read.csv("forage_fall_2023.csv", header = TRUE)
...
intercept2 = 26.74693    # look at p2_mod and extract the intercept
...
p2 = ggplot() + 
  ...
  geom_point(data = ds2[58, ], aes(x = YEAR, y = strat.biomass), shape = 17, size = 3) + 
