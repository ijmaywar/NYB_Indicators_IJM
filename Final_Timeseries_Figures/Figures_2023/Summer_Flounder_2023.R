...
ds<-read.csv("summerflounder_spring_2023.csv", header = TRUE)
...
ds2<-read.csv("summerflounder_fall_2023.csv", header = TRUE)
...
intercept2 = 0.9988367     # look at p2_mod and extract the intercept
