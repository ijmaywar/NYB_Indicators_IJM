...
ds<-read.csv("longfin_spring_2023.csv", header = TRUE)
...
ds2<-read.csv("longfin_fall_2023.csv", header = TRUE)
...
intercept2 =  13.69341  # look at p2_mod and extract the intercept
...
p2 = ggplot() + 
  ...
  geom_point(data = ds2[57, ], aes(x = YEAR, y = strat.biomass), shape = 17, size = 3) + 
