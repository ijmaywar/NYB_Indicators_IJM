...
ds2_p<-read.csv("pelagic_fall_2022.csv", header = TRUE)
ds2_b<-read.csv("benthic_fall_2022.csv", header = TRUE)
...
intercept2 =  5.765635      # look at p2_mod and extract the intercept
...
p2 = ggplot() + 
  ...
  geom_point(data = ds2_p[57, ], aes(x = YEAR, y = ratio), shape = 17, size = 3) + 
