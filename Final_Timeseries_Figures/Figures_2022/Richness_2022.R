...
ds<-read.csv("richness_spring_2022.csv", header = TRUE)
...
ds2<-read.csv("richness_fall_2022.csv", header = TRUE)
...
intercept2 = 52.82456    # look at p2_mod and extract the intercept
...
p2 = ggplot() + 
  ...
  geom_point(data = ds2[57, ], aes(x = YEAR, y = n), shape = 17, size = 3) + 
