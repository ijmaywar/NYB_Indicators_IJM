## Figures for Average Trophic Level of Fish Community
...
ds<-read.csv("avgtl_spring_2022.csv", header = TRUE)
...
ds2<-read.csv("avgtl_fall_2022.csv", header = TRUE)
...
intercept2 = 3.931109    # look at p2_mod and extract the intercept
...
p2 = ggplot() + 
  ...
  geom_point(data = ds2[57, ], aes(x = YEAR, y = TL), shape = 17, size = 3) + 
