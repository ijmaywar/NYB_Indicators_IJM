...
BT<-read.csv("BT_insitu_Nov_23_2021.csv", header = TRUE)
BT
...
intercept = 2.467162e-17 # look at p2_mod and extract the intercept
...
Term = "Year"
mod.d <- Deriv(mod, n=81) # n is the number of years
