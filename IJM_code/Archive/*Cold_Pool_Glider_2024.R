...
#
# Figures for Cold Pool glider data
# 
...
df<-read.csv("Cold_Pool_Glider_2023.csv", header = TRUE)

###################


year = c(2018.875,2018.875, 2019.875,2019.875, 2020.875,2020.875, 2021.875,2021.875,2022.875, 2022.875,2023.875, 2023.875)
yval = c(0, 8, 0, 8, 0, 8, 0, 8, 0, 8,0,8)

vertical_lines <- data.frame(year, yval)
ggplot() + 
  
  geom_rect(aes(xmin=2018.875, xmax=2019.125, ymin=0, ymax=8), fill = 'lightblue', alpha = 0.5) +
  geom_rect(aes(xmin=2019.125, xmax=2019.375, ymin=0, ymax=8), fill = 'violet', alpha = 0.5) +
  geom_rect(aes(xmin=2019.375, xmax=2019.625, ymin=0, ymax=8), fill = 'green', alpha = 0.5) +
  geom_rect(aes(xmin=2019.625, xmax=2019.875, ymin=0, ymax=8), fill = 'orange', alpha = 0.5) +
  
  geom_rect(aes(xmin=2019.875, xmax=2020.125, ymin=0, ymax=8), fill = 'lightblue', alpha = 0.5) +
  geom_rect(aes(xmin=2020.125, xmax=2020.375, ymin=0, ymax=8), fill = 'violet', alpha = 0.5) +
  geom_rect(aes(xmin=2020.375, xmax=2020.625, ymin=0, ymax=8), fill = 'green', alpha = 0.5) +
  geom_rect(aes(xmin=2020.625, xmax=2020.875, ymin=0, ymax=8), fill = 'orange', alpha = 0.5) +
  
  geom_rect(aes(xmin=2020.875, xmax=2021.125, ymin=0, ymax=8), fill = 'lightblue', alpha = 0.5) +
  geom_rect(aes(xmin=2021.125, xmax=2021.375, ymin=0, ymax=8), fill = 'violet', alpha = 0.5) +
  geom_rect(aes(xmin=2021.375, xmax=2021.625, ymin=0, ymax=8), fill = 'green', alpha = 0.5) +
  geom_rect(aes(xmin=2021.625, xmax=2021.875, ymin=0, ymax=8), fill = 'orange', alpha = 0.5) +
  
  geom_rect(aes(xmin=2021.875, xmax=2022.125, ymin=0, ymax=8), fill = 'lightblue', alpha = 0.5) +
  geom_rect(aes(xmin=2022.125, xmax=2022.375, ymin=0, ymax=8), fill = 'violet', alpha = 0.5) +
  geom_rect(aes(xmin=2022.375, xmax=2022.625, ymin=0, ymax=8), fill = 'green', alpha = 0.5) +
  geom_rect(aes(xmin=2022.625, xmax=2022.875, ymin=0, ymax=8), fill = 'orange', alpha = 0.5) +
  
  geom_rect(aes(xmin=2022.875, xmax=2023.125, ymin=0, ymax=8), fill = 'lightblue', alpha = 0.5) +
  geom_rect(aes(xmin=2023.125, xmax=2023.375, ymin=0, ymax=8), fill = 'violet', alpha = 0.5) +
  geom_rect(aes(xmin=2023.375, xmax=2023.625, ymin=0, ymax=8), fill = 'green', alpha = 0.5) +
  geom_rect(aes(xmin=2023.625, xmax=2023.875, ymin=0, ymax=8), fill = 'orange', alpha = 0.5) +
  ...
  geom_point(data = df, aes(x = Year_frac, y = X10C), color = 'black', size =3, shape = 2) +
  geom_point(data = df, aes(x = Year_frac, y = X9C), color = 'black', size =3, shape = 8) +

  theme_bw() +
  labs (y = bquote("Area "~km^2~" "), x = '', title = 'Area of the Cold Pool') + 
  theme(axis.text.x=element_blank(),
        axis.ticks.x=element_blank() 
  )+
  annotate("text", x = 2019.35, y = -1.15, label = "2019", size=5)+
  annotate("text", x = 2020.35, y = -1.15, label = "2020", size=5)+
  annotate("text", x = 2021.35, y = -1.15, label = "2021", size=5)+
  annotate("text", x = 2022.35, y = -1.15, label = "2022", size=5)+
  annotate("text", x = 2023.35, y = -1.15, label = "2023", size=5)+
  coord_cartesian(ylim = c(-0.25, 8),  clip = 'off') +
