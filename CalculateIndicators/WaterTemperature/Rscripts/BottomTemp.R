...
plot(NYB_m1$fitted.values, NYB_m1$y, pch = 19, cex = .1,
...
plot(fNYB$Year, scale(fNYB$Val, scale = FALSE), type = "l")
abline(h = 0)
...
write.csv(fff, "BT_insitu_AUG_10_2020.csv")
