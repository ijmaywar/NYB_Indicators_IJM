...
The world ocean dataset has an extensive record of CTD casts. As of September 2019, there are about 80,000 casts completed in the NE US Continental shelf large marine ecosystem. These can be used for a variety of indicators.
...
From here, I de-selected all of the available data types EXCEPT for 'High resolution CTD/XCTD (CTD)'. I didnt want to deal with all that shit, so I just got the CTD casts and entered the geographic coordiantes as follows 
...
file1 <- ("ocldb1729093373.1000158_CTD.nc")#straight from WODselect download site
file2 <- ("ocldb1729093373.1000158_CTD2.nc")#straight from WODselect download site
...
write.csv(finalDDD,"WOD_CTD_format_D50_Oct16_2024.csv")
