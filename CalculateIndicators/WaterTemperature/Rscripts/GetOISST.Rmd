...
OISST_sub <- function(times, mypath){
  oisst_res <- griddap(
    # x = "ncdc_oisst_v2_avhrr_by_time_zlev_lat_lon", 
    # url = "https://www.ncei.noaa.gov/erddap/", 
    # x = "ncdcOisst2Agg_LonPM180", ###NEW TRU
    # url = "https://coastwatch.pfeg.noaa.gov/erddap/griddap/",###NEW TRY

    info("ncdcOisst2Agg_LonPM180", url = "https://coastwatch.pfeg.noaa.gov/erddap/"),
...
#####I turned these off here,but you need to run these to access the datasets and store them somewher!!!
  ...
  OISST7  <- OISST_sub(c("2020-01-01T00:00:00Z", "2023-12-31T12:00:00Z"),mypath) # until the end of 2023
