...
Created by Kurt Heim
Edited by Laura Gruenburg (Dec 01, 2021)
...
ADDED AUG 12,2020 center of fall flow and center of spring flow as per Hodgkins et al. 2003 which is mroe relevant to the East Coast than some of the other ones. 
...
# hudson <- "403654074034101" # Hudson River at The Narrows
...
gam_mod<-gam(mean_flow*cfs_to_cms ~ s(wyear, k = 10), data = flowdat_hudson)
...
write.csv(flow, "RiverFlow_OCT_23_2024.csv") #Don't forget to change the name each year!
